...
if __name__ == "__main__":
    ...
    list1=['gMH_sBM_c01_d23_mMH0_ch07','gJB_sBM_c01_d07_mJB1_ch07','gMH_sBM_c03_d22_mMH1_ch08',
           'gPO_sBM_c01_d10_mPO2_ch10','gPO_sBM_c02_d11_mPO0_ch09','gWA_sFM_c02_d25_mWA3_ch04']#gWA_sFM_c02_d25_mWA3_ch04'
    #list1=['gKR_sFM_c09_d28_mKR1_ch02']
    
    for name in list1:
        
        save_name = 'QT'+name+'gKR_sFM_c09_d28_mKR1_ch02_MMV_r12_0_2QT.npy'
        ...
        f_v_name = 'gKR_sFM_c09_d28_mKR1_ch02.npy'#视频特征向量

        f_m_root=os.path.join('/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Data/Aistt_Music_mel',f_m_name)
        ...
        for i in range(number):
            if i==0:
                g = ddpm.generate_1x1_image(noise,music.unsqueeze(0).unsqueeze(1),video[0].unsqueeze(0).unsqueeze(1))
                print(g.shape)
                music_G.append(g)
            else:
