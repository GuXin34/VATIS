...
class UNet(nn.Module):
    def __init__(
        ...
        self.Vconv1x1 = nn.Conv2d(in_channels=512, out_channels=88, kernel_size=1, stride=1, padding=0)#------80-->88----
        ...
        self.attention              =  AttentionBlock(base_channels, norm, num_groups)
