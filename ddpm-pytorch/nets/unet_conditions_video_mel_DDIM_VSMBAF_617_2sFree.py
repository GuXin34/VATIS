...
class UNet(nn.Module):
    def __init__(
        ...
        self.Vconv1 = nn.Conv2d(in_channels=2, out_channels=n_filters, kernel_size=3, stride=1, padding=1)
        ...
        self.Vconv3 = nn.Conv2d(in_channels=n_filters//2, out_channels=2, kernel_size=1, stride=1)
...
# 再次交换轴，将通道数放回最后
        ...
        for layer in self.downs:
            h,h_f = layer(h, h_f,time_emb, y,video_emb)
            skips.append(h)
            skips_f.append(h_f)
