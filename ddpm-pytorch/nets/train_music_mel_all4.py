...
from utils.dataloader_music_mel_all4 import Diffusion_dataset_collate, DiffusionDataset
...
if __name__ == "__main__":
    ...
    #   获得图片路径
    #------------------------------------------#
    annotation_path = '/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Data/video_music_all.txt'
