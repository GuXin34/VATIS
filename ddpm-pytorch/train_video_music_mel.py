...
from utils.dataloader_video import Diffusion_dataset_collate, DiffusionDataset
...
if __name__ == "__main__":
    ...
    #   获得图片路径
    #------------------------------------------#
    annotation_path = '/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Data/Aistt_list_all.txt'
