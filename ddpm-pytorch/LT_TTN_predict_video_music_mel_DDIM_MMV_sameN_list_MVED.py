...
from utils.utils import preprocess_input_video_MVED,preprocess_input_mel
import os
import torch
import numpy as np
...
if __name__ == "__main__":
    ...
    list_seed=[675248436,675248436]
    j=0
    for name in list1:
        
        save_name = name+'VSMBFS2_LT_2T_675seed_new2.npy'
        ...
        video=preprocess_input_video_MVED(torch.tensor(video)[:,:]).float()#全部帧
