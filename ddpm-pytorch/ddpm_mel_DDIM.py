...
class Diffusion(object):
    _defaults = {
        ...
        #-----------------------------------------------#
        "model_path"        : '/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Data/logs1/1116Diffusion_Epoch430-GLoss0.0188.pth',
        #-----------------------------------------------#
        #   卷积通道数的设置
        #-----------------------------------------------#
        "channel"           : 32,
    ...
    def generate_1x1_image(self, save_path='',video=None):
        with torch.no_grad():
            ...
            test_images = self.net.sample(1, randn_in.device, self.num_timesteps,None, use_ema=False)#最初video.size(0)是1
