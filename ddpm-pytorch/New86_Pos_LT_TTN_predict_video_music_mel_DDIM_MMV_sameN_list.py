...
if __name__ == "__main__":
    ...
    def MM_melV2_out(x):
        x *= 0.5
        x += 0.5
        x =13.69251*x-11.51293#10.09142302*x-6.46885724
        return x
    ...
    list2=['gWA_sBM_c02_d25_mWA2_ch10','gWA_sBM_c09_d25_mWA3_ch10','gPO_sBM_c03_d11_mPO0_ch09','gMH_sBM_c02_d24_mMH5_ch08',
    ...
    for N in range(NUMBER):
        ...
        for name in list2:
            ...
            save_name = name+'VSMBFS15_New_88_'+str(seed)+'.npy'
        ...
        # 创建一个形状为 (3, 4) 的张量，填充标准正态分布的随机数
            ...
            for i in range(len(music_G)):
                test_images = MM_melV2_out(music_G[i].cpu().data.numpy()).squeeze()
                if i==0:
