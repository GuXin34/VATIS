...
class Diffusion(object):
    _defaults = {
        ...
        #-----------------------------------------------#
        "model_path"        : '/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Data/logs1/1020Diffusion_Epoch460-GLoss0.0185.pth',
        #-----------------------------------------------#
        #   卷积通道数的设置
        #-----------------------------------------------#
        "channel"           : 32,
    ...
    def generate_1x1_image(self, save_path='',video=None):
        with torch.no_grad():
            ...
            test_images = self.net.sample(video.size(0), randn_in.device, None, use_ema=False,video=video)#最初video.size(0)是1
            ...
            for i in test_images:
                list1.append(i)
            result = np.concatenate(list1, axis=1)
