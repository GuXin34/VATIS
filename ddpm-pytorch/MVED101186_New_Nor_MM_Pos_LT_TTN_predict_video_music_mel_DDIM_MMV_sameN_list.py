...
from utils.utils_Normalization import MVED_preprocess_input_mel_Nor_V2,MVED_MM_melV2
import os
import torch
import numpy as np
...
#'gWA_sBM_c02_d25_mWA2_ch10','gWA_sBM_c09_d25_mWA3_ch10','gPO_sBM_c03_d11_mPO0_ch09','gMH_sBM_c02_d24_mMH5_ch08','gLO_sBM_c09_d14_mLO0_ch09','gJS_sBM_c02_d03_mJS2_ch03','gJB_sBM_c09_d07_mJB3_ch06','gHO_sBM_c07_d19_mHO1_ch10','gBR_sBM_c06_d06_mBR4_ch06','gKR_sFM_c09_d28_mKR1_ch02']
    ...
    for N in range(NUMBER):
        ...
        save_path_N=os.path.join('/home/vatis/DataDisk_1/23_vatis_PhD/guxin/10GEN/MVED23',str(N)) 
        ...
        for name in list4:
            ...
            f_m_root=os.path.join('/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Data/MVED_Music_melV2',f_v_name)
            ...
            m = np.load(f_m_root)
            m =MVED_MM_melV2(MVED_preprocess_input_mel_Nor_V2(torch.tensor(m)).float())
            #print(m.shape)
        ...
        # 创建一个形状为 (3, 4) 的张量，填充标准正态分布的随机数
            ...
            for i in range(number):
                if i==0:
                    ...
                    #m = m.squeeze()[:,:88].unsqueeze(0).unsqueeze(0)
                    #music=m.to(device)
