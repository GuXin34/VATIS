...
from utils.utils_Normalization import preprocess_input_mel_Nor_V2,MM_melV2
...
if __name__ == "__main__":
    ...
    list2=['gBR_sBM_c09_d06_mBR4_ch06','gHO_sBM_c09_d20_mHO1_ch06','gJB_sBM_c01_d08_mJB1_ch04','gKR_sBM_c09_d30_mKR3_ch08','gLH_sBM_c09_d16_mLH3_ch01','gWA_sBM_c09_d26_mWA4_ch10','gWA_sBM_c09_d27_mWA5_ch04']
...
#'gWA_sBM_c02_d25_mWA2_ch10','gWA_sBM_c09_d25_mWA3_ch10','gPO_sBM_c03_d11_mPO0_ch09','gMH_sBM_c02_d24_mMH5_ch08','gLO_sBM_c09_d14_mLO0_ch09','gJS_sBM_c02_d03_mJS2_ch03','gJB_sBM_c09_d07_mJB3_ch06','gHO_sBM_c07_d19_mHO1_ch10','gBR_sBM_c06_d06_mBR4_ch06','gKR_sFM_c09_d28_mKR1_ch02']
    list4=['gBR_sFM_c08_d04_mBR1_ch02','gWA_sFM_c09_d25_mWA1_ch02']#['gWA_sBM_c09_d27_mWA5_ch04','gLH_sBM_c09_d16_mLH3_ch01']#gBR_sFM_c08_d04_mBR1_ch02,gWA_sFM_c09_d25_mWA1_ch02
    ...
    for N in range(NUMBER):
        ...
        save_path_N=os.path.join('/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Aistt_DDIM_input',str(0)) 
        ...
        for name in list2:
            ...
            seed =42
            save_name = name+'Base_'+str(seed)+'.npy'
            ...
            m = np.load(f_m_root)
            m= MM_melV2(preprocess_input_mel_Nor_V2(torch.tensor(m)).float())
            #print(m.shape)
        ...
        # 创建一个形状为 (3, 4) 的张量，填充标准正态分布的随机数
            ...
            for i in range(number):
                if i==0:
                    #video_=V_LT(video,0).cuda()
                    music = m.squeeze()[:,:88].unsqueeze(0).unsqueeze(0).to(device)
