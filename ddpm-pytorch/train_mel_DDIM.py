...
from utils.dataloader_music_mel_all import Diffusion_dataset_collate, DiffusionDataset
from utils.utils import get_lr_scheduler, set_optimizer_lr, show_config
from utils.utils_fit_sample import fit_one_epoch
...
if __name__ == "__main__":
    ...
    #   获得图片路径
    #------------------------------------------#
    annotation_path = '/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Data/video_music_all_new_half.txt'
