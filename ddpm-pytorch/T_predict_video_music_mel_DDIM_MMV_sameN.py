...
if __name__ == "__main__":
    ...
    save_path = "/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Aistt_DDIM_input/gJB_sBM_c02_d09_mJB3_ch03_0509_r10_MMV_10T_sameN.npy"

    #ddpm = Diffusion('F:/Code_save/diffusion_model_last_epoch_weights.pth')
    ddpm = Diffusion()
        
    f_v_name='gJB_sBM_c02_d09_mJB3_ch03.npy'#视频特征向量
