...
from utils.dataloader_video_3_guiyi import Diffusion_dataset_collate, DiffusionDataset
from utils.utils import get_lr_scheduler, set_optimizer_lr, show_config
from utils.utils_fit_0913 import fit_one_epoch
...
if __name__ == "__main__":
    ...
    #------------------------------------------------------------------#
    save_dir            = '/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Data/logs1'
    #------------------------------------------------------------------#
    ...
    #   获得图片路径
    #------------------------------------------#
    annotation_path = '/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Data/video_music_all_new.txt'
    ...
    #   Diffusion网络
    #----------------------------------------------------------------------------------------------------#
    diffusion_model = GaussianDiffusion(UNet(4, channel), input_shape, 4, betas=betas)
