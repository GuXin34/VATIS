...
if __name__ == "__main__":
    ...
    #   获得图片路径
    #------------------------------------------#
    annotation_path = '/home/vatis/DataDisk_1/23_vatis_PhD/guxin/Data/video_music_train.txt'
    ...
    #   Diffusion网络
    #----------------------------------------------------------------------------------------------------#
    diffusion_model = GaussianDiffusion(UNet(2, channel), input_shape, 2, betas=betas)
